...
<div class="verify-email">
    <table border="0" cellpadding="0" cellspacing="0" width="450" style="width:450px; max-width:450px; margin:0 auto; table-layout: fixed">
        <tr>
            <td>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="450" style="border-collapse: collapse; background-color: #ffffff; box-shadow: 0px 4px 15px 0px rgba(0, 0, 0, 0.1); width: 450px">
                    <tr>
                        <td>
